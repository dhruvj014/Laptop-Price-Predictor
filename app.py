...
df = pickle.load(open('https://github.com/dhruvj014/Laptop-Price-Predictor/blob/main/df.pkl','rb'))
pipe = pickle.load(open('https://github.com/dhruvj014/Laptop-Price-Predictor/blob/main/pipe.pkl','rb'))
